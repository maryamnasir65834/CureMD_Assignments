  ...
  public static int[] Remove_Duplicates(int[] array)
    {
      ...
      Array.Sort(array);                        // sorting array of keep elments in an order
      ...
      {
        if (array[j] != array[i])               // comparing elements of specified indices if                                                     they are not equal then we have a unique                                                       element otherwise we move forward with the                                                     i's index
        {
          i++;
